...
namespace ReversiMaui
{
    public class ReversiViewModel : ViewModelBase
    {
        ...
        private GameSizesViewModel _sizes;
        ...
        public ObservableCollection<GameSizesViewModel> BoardSizes { get; set; }
        ...
        public GameSizesViewModel Sizes
        {
            get => _sizes;
            set
            {
                _sizes = value;
                _model.BoardSize = value.Size;
        ...
        public ReversiViewModel(ReversiGameModel model)
        {
            ...
            _model.GameCreated += new EventHandler<ReversiEventArgs>(Model_GameCreated);
            ...
            BoardSizes = new ObservableCollection<GameSizesViewModel>
            {
                new GameSizesViewModel { Size = BoardSize.Smol },
                new GameSizesViewModel { Size = BoardSize.Medium },
                new GameSizesViewModel { Size = BoardSize.Big }
            };

            _model.CurrentPlayer = 1;
            Sizes = BoardSizes[1]; // medium
        ...
        private void Model_GameCreated(object? sender, EventArgs e)
        {
            ...
            Sizes = _model.BoardSize switch
            {
                BoardSize.Smol => BoardSizes[0],
                BoardSize.Medium => BoardSizes[1],
                BoardSize.Big => BoardSizes[2],
                _ => BoardSizes[1]
            };
